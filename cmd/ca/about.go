...
<h3 id="-request_cert-b64pubkey-b64_pubkey-user-ssh_username-get-authenticated-">/request_cert?b64pubkey=<b64_pubkey>&amp;user=<ssh_username> - GET {AUTHENTICATED}</h3>
...
<p>SSH Servers will need to have the <code>TrustedUserCAKeys</code> option set in their configuration file in order for the user certificates to be used as an authentication mechanism. This option should point to a local copy of the SSH CA&#39;s public key (reachable at the <code>/ca.pub</code> endpoint).</p>
